//
//  WZPSideViewController.m
//  WZPLeftSideController
//
//  Created by coderAldon on 2017/8/12.
//  Copyright © 2017年 coderAldon. All rights reserved.
//

#import "WZPSideViewController.h"

@interface WZPSideViewController ()<UIGestureRecognizerDelegate>
...
@implementation WZPSideViewController
{
...
-(void)setNewRootViewController:(UIViewController *)viewController animation:(BOOL)animation{
    ...
    if (g_menuFlags.showingLeftView) {
        ...
        CGAffineTransform transScale = CGAffineTransformMakeScale(_scaleSize, _scaleSize);
        CGAffineTransform transConcat = CGAffineTransformConcat(transRight, transScale);
        __block WZPSideViewController *selfRef = self;
